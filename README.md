...
2. **Either** select the parameters you want to use to filter your dataset (using the [parameters available in the GBIF Occurrence Search API](https://techdocs.gbif.org/en/openapi/v1/occurrence)), **or** by [creating your own dataset](https://www.gbif.org/occurrence/search) and passing the `datasetID` parameter. See **Example Usage**.
...
For this example we use the dataset at https://doi.org/10.15468/dl.dk9czq
```python
import os
import bplusplus
from typing import Any
...
search: dict[str, Any] = {
    "scientificName": names,
    "datasetID": "https://doi.org/10.15468/dl.dk9czq"
}
